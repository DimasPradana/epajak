...
define('SW_PROJECT_PASSWORD', 'epajak');
...
define('SW_PROJECT_TITLE', 'epajak report');
...
define('SW_DB_USER', 'epajak');
define('SW_DB_PASSWORD', '51p4j4k');
define('SW_DB_HOST', '127.0.0.1');
define('SW_DB_DATABASE', 'e-pajak');
}
