...
<!--
    <div class="smallbanner">Powered by <a href="http://www.reportico.org/" target="_blank">reportico {$REPORTICO_VERSION}</a></div> <!--Dimas update footer reportico-->
-->
<div class="smallbanner">Powered by BPPKAD SITUBONDO</div>
</div>
{if !$REPORTICO_AJAX_CALLED}
{if !$EMBEDDED_REPORT} 
</BODY>
