        ...
        <div class="row">
          <div class="col-md-12 panel-warning">
            ...
            <div class="tab-content">
              ...
              <button type="button" class="btn btn-info btn-md" data-toggle="modal" data-target="#cetakspt" style="display:none">Cetak Laporan SPTPD</button><!--dimas update hide button cetak-->
              <br>
              <br>
        ...
        <div class="row">
          <div class="col-md-12 panel-warning">
            ...
            <div class="tab-content">
              ...
              <button type="button" class="btn btn-info btn-md" data-toggle="modal" data-target="#cetakspt" style="display:none">Cetak Laporan SKP</button><!--dimas update hide button cetak-->
              <br>
              <br>
